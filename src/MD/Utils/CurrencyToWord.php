...
class CurrencyToWord {
    ...
    public static function convertNumber($num, $currency = "USD") {
        if (stristr($num, ".")) {
        ...
        if ($num{0} == "0")
            ...
            for ($z = 0; $z < count($groups2); $z++) {
                if ($groups2[$z] != "") {
                    $output .= $groups2[$z] . self::convertGroup(11 - $z) . ($z < 11 && !array_search('', array_slice($groups2, $z + 1, -1)) && $groups2[11] != '' && $groups[11]{0} == '0' ? " and " : ", ");
                }
            }
        ...
        if ($dec > 0) {
            ...
            if (strlen($dec) == 2)
                ...
                $output .= " " . self::convertTwoDigit($dec{0}, 0);
