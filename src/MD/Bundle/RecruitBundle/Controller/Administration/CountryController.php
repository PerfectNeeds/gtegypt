...
use MD\Bundle\RecruitBundle\Entity\Country;
use MD\Bundle\RecruitBundle\Form\CountryType;
...
class CountryController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('RecruitBundle:Country')->findAll();
     ...
     * @Method("POST")
     * @Template("RecruitBundle:Country:new.html.twig")
     */
    ...
    public function editAction($id) {
        ...
        $entity = $em->getRepository('RecruitBundle:Country')->find($id);
     ...
     * @Method("PUT")
     * @Template("RecruitBundle:Country:edit.html.twig")
     */
